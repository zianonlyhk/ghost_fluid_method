...
set cbrange [STATS_min:STATS_max]
do for [i=1:int(STATS_blocks)-1] {
    splot 'test_momentumX_Results.dat' index (i-1) using 3:2:4 with lines palette notitle
}
...
# set cbrange [STATS_min:STATS_max]
# do for [i=1:int(STATS_blocks)-1] {
#     splot 'test_momentumY_Results.dat' index (i-1) using 3:2:4 with lines palette notitle
# }
...
set cbrange [STATS_min:STATS_max]
do for [i=1:int(STATS_blocks)-1] {
    splot 'test_energyResults.dat' index (i-1) using 3:2:4 with lines palette notitle
}
