...
#    Updated: 2023/01/21 12:58:10 by Zian Huang                                #
#                                                                              #
# **************************************************************************** #
...
objects = $(obj_dir)/flux_func.o $(obj_dir)/gfm_2d_euler_solver.o $(obj_dir)/vec_transform.o $(obj_dir)/exec_interface.o

all: flux_func.o gfm_2d_euler_solver.o vec_transform.o exec_interface.o
